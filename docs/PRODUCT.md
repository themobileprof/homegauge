...
| AI runtime | Use AI only where code cannot match quality (e.g. salary statement extraction). Eligibility, calculator, readiness, and advisor checklists are **programmatic**. |
